...
|:---:|:---:|:---:|:---:|
| 0 (Проверяется Tinkoff ID при авторизации пользователя) | Антифрод проверки | Редирект пользователя с "access_denied" | Заголовок: Что-то пошло не так. Текст: Напишите в поддержку в личном кабинете Тинькофф |
